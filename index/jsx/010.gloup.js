...
},{"../model":19,"./injection-handler":17,"lodash.get":8,"lodash.set":9}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./container-binding-config":14,"./container-namespaces":15,"./injection-handler":17}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./container/container":16,"./model":19,"reflect-metadata":11}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
},{"./container/injection-handler":17,"./model":19}],21:[function(require,module,exports){
"use strict";
/**
...
(function (global){(function (){
global.GLOUP = require("../dist/010.gloup/hunt");
global.GLOUP.ActGlp = require("../dist/010.gloup/00.gloup.unit/gloup.action");
//global.MQTT = require("async-mqtt");
}).call(this)}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../dist/010.gloup/00.gloup.unit/gloup.action":24,"../dist/010.gloup/hunt":54}],23:[function(require,module,exports){
(function (process){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.startGloup = exports.openGloup = exports.updateGloup = exports.initGloup = void 0;
const ActMnu = require("../../98.menu.unit/menu.action");
const ActBus = require("../../99.bus.unit/bus.action");
const ActGlp = require("../../00.gloup.unit/gloup.action");
const ActVrt = require("../../act/vurt.action");
const ActDsk = require("../../act/disk.action");
const ActMap = require("../../act/hexmap.action");
var bit, val, idx, dex, lst, dat;
const initGloup = async (cpy, bal, ste) => {
    if (bal.dat != null)
        bit = await ste.hunt(ActBus.INIT_BUS, { idx: cpy.idx, lst: [ActGlp, ActMnu], dat: bal.dat, src: bal.src });
    if (bal.val == 1)
        patch(ste, ActMnu.INIT_MENU, bal);
    if (bal.slv != null)
        bal.slv({ intBit: { idx: "init-gloup" } });
    return cpy;
};
exports.initGloup = initGloup;
const updateGloup = async (cpy, bal, ste) => {
    process.chdir("../999.vurt");
    bit = await ste.bus(ActVrt.BUNDLE_VURT, { src: '010.gloup' });
    process.chdir("../010.gloup");
    bit = await ste.bus(ActDsk.READ_DISK, { src: './work/010.gloup.js' });
    var gloup = bit.dskBit.dat;
    bit = await ste.bus(ActDsk.WRITE_DISK, { src: '../gillisse/public/jsx/010.gloup.js', dat: gloup });
    if (bal.slv != null)
        bal.slv({ spcBit: { idx: "update-space" } });
    return cpy;
};
exports.updateGloup = updateGloup;
const openGloup = async (cpy, bal, ste) => {
    bit = await ste.bus(ActMap.LIST_HEXMAP, { idx: '../010.gloup' });
    lst = bit.mapBit.lst;
    bit = await ste.bus(ActMap.LOAD_HEXMAP, { idx: '../010.gloup', src: lst[0] });
    //bit = await ste.bus(ActDis.OPEN_DISCORD, {});
    //lst = [];
    //for (var key in COMMAND) {
    //   var itm = COMMAND[key]
    //   lst.push(itm)
    // }
    // bit = await ste.bus(ActCmd.OPEN_COMMAND, { lst });
    //send commands 
    // bit = await ste.bus(ActCli.OPEN_CLIENT, {});
    //now let us open the shade 
    //const open = require('open')
    //   var loc = './vew.shd.bat'
    //   bit = await open(loc)
    //  process.chdir("../110.shade");
    //   setTimeout(() => {
    //       if (bal.slv != null) bal.slv({ glpBit: { idx: "open-gloup" } });
    //   }, 33)
    if (bal.slv != null)
        bal.slv({ glpBit: { idx: "open-gloup" } });
    return cpy;
};
exports.openGloup = openGloup;
var patch = (ste, type, bale) => ste.dispatch({ type, bale });
const startGloup = (cpy, bal, ste) => {
    console.log("discord now needs to figure out how to respond ");
    var userIDX = bal.src;
    debugger;
    return cpy;
};
exports.startGloup = startGloup;

}).call(this)}).call(this,require('_process'))
},{"../../00.gloup.unit/gloup.action":24,"../../98.menu.unit/menu.action":36,"../../99.bus.unit/bus.action":41,"../../act/disk.action":49,"../../act/hexmap.action":50,"../../act/vurt.action":53,"_process":10}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.StartGloup = exports.START_GLOUP = exports.OpenGloup = exports.OPEN_GLOUP = exports.UpdateGloup = exports.UPDATE_GLOUP = exports.InitGloup = exports.INIT_GLOUP = void 0;
// Gloup actions
exports.INIT_GLOUP = "[Gloup action] Init Gloup";
class InitGloup {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.INIT_GLOUP;
    }
}
exports.InitGloup = InitGloup;
exports.UPDATE_GLOUP = "[Gloup action] Update Gloup";
class UpdateGloup {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.UPDATE_GLOUP;
    }
}
exports.UpdateGloup = UpdateGloup;
exports.OPEN_GLOUP = "[Open action] Open Gloup";
class OpenGloup {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.OPEN_GLOUP;
    }
}
exports.OpenGloup = OpenGloup;
exports.START_GLOUP = "[Start action] Start Gloup";
class StartGloup {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.START_GLOUP;
    }
}
exports.StartGloup = StartGloup;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.startGloup = exports.openGloup = exports.updateGloup = exports.initGloup = void 0;
var gloup_buzz_1 = require("./buz/gloup.buzz");
Object.defineProperty(exports, "initGloup", { enumerable: true, get: function () { return gloup_buzz_1.initGloup; } });
var gloup_buzz_2 = require("./buz/gloup.buzz");
Object.defineProperty(exports, "updateGloup", { enumerable: true, get: function () { return gloup_buzz_2.updateGloup; } });
var gloup_buzz_3 = require("./buz/gloup.buzz");
Object.defineProperty(exports, "openGloup", { enumerable: true, get: function () { return gloup_buzz_3.openGloup; } });
var gloup_buzz_4 = require("./buz/gloup.buzz");
Object.defineProperty(exports, "startGloup", { enumerable: true, get: function () { return gloup_buzz_4.startGloup; } });

},{"./buz/gloup.buzz":23}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.GloupModel = void 0;
class GloupModel {
    constructor() {
        this.idx = '010.gloup';
        //gloupBitList: GloupBit[] = [];
        //gloupBits: any = {};
    }
}
exports.GloupModel = GloupModel;
...
const Act = require("./gloup.action");
const gloup_model_1 = require("./gloup.model");
const Buzz = require("./gloup.buzzer");
function reducer(model = new gloup_model_1.GloupModel(), act, state) {
    switch (act.type) {
        case Act.UPDATE_GLOUP:
            return Buzz.updateGloup(clone(model), act.bale, state);
        case Act.INIT_GLOUP:
            return Buzz.initGloup(clone(model), act.bale, state);
        case Act.OPEN_GLOUP:
            return Buzz.openGloup(clone(model), act.bale, state);
        case Act.START_GLOUP:
            return Buzz.startGloup(clone(model), act.bale, state);
        default:
            return model;
    }
}
...
},{"./gloup.action":24,"./gloup.buzzer":25,"./gloup.model":26,"clone-deep":3}],28:[function(require,module,exports){
"use strict";
...
let GloupUnit = class GloupUnit {
    constructor(state) {
    }
};
GloupUnit = __decorate([
    typescript_ioc_1.Singleton,
    __metadata("design:paramtypes", [state_1.default])
], GloupUnit);
exports.default = GloupUnit;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.renderMenu = exports.closeMenu = exports.testMenu = exports.updateMenu = exports.initMenu = void 0;
...
const updateMenu = async (cpy, bal, ste) => {
    ...
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "GLOUP PIVOT V0", bit: 'local' });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
    var lst = [ActGlp.OPEN_GLOUP, ActGlp.UPDATE_GLOUP, ActMnu.RENDER_MENU];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActGlp.OPEN_GLOUP:
            bit = await ste.hunt(ActGlp.OPEN_GLOUP, {});
            break;
        case ActGlp.UPDATE_GLOUP:
            bit = await ste.hunt(ActGlp.UPDATE_GLOUP, {});
            break;
        case ActMnu.RENDER_MENU:
            bit = await ste.hunt(ActMnu.RENDER_MENU, {});
            break;
        default:
...
const renderMenu = async (cpy, bal, ste) => {
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: 'local' });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "RENDER PIVOT V0", bit: 'local' });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
    var lst = [ActVsg.RENDER_VISAGE];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActVsg.RENDER_VISAGE:
            bit = await ste.bus(ActVsg.RENDER_VISAGE, { idx: "surface" });
            break;
        default:
            bit = await await ste.bus(ActTrm.CLOSE_TERMINAL, {});
            break;
...
},{"../../00.gloup.unit/gloup.action":24,"../../act/terminal.action":51,"../../act/visage.action":52,"../menu.action":36}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.RenderMenu = exports.RENDER_MENU = exports.DiscordMenu = exports.DISCORD_MENU = exports.CloseMenu = exports.CLOSE_MENU = exports.TestMenu = exports.TEST_MENU = exports.UpdateMenu = exports.UPDATE_MENU = exports.InitMenu = exports.INIT_MENU = void 0;
...
exports.CloseMenu = CloseMenu;
exports.DISCORD_MENU = "[Discord action] Discord Menu";
class DiscordMenu {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.DISCORD_MENU;
    }
}
exports.DiscordMenu = DiscordMenu;
...
Object.defineProperty(exports, "renderMenu", { enumerable: true, get: function () { return menu_buzz_5.renderMenu; } });

},{"./buz/menu.buzz":35}],38:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const gloup_unit_1 = require("./00.gloup.unit/gloup.unit");
...
const gloup_model_1 = require("./00.gloup.unit/gloup.model");
...
exports.list = [gloup_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromGloup = require("./00.gloup.unit/gloup.reduce");
...
class UnitData {
    constructor() {
        this.gloup = new gloup_model_1.GloupModel();
...
},{"./00.gloup.unit/gloup.model":26,"./00.gloup.unit/gloup.reduce":27,"./00.gloup.unit/gloup.unit":28,"./97.collect.unit/collect.model":32,"./97.collect.unit/collect.reduce":33,"./97.collect.unit/collect.unit":34,"./98.menu.unit/menu.model":38,"./98.menu.unit/menu.reduce":39,"./98.menu.unit/menu.unit":40,"./99.bus.unit/bus.model":43,"./99.bus.unit/bus.reduce":44,"./99.bus.unit/bus.unit":45}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.RENDER_VISAGE = exports.CREATE_VISAGE = exports.WRITE_VISAGE = exports.READ_VISAGE = exports.FULLSCREEN_VISAGE = exports.UPDATE_VISAGE = exports.INIT_VISAGE = void 0;
