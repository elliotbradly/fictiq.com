...
(function (global){(function (){
global.STYLE = require("../dist/109.style/hunt");
global.STYLE.ActSty = require("../dist/109.style/00.style.unit/style.action");
...
},{"../dist/109.style/00.style.unit/style.action":24,"../dist/109.style/hunt":52}],23:[function(require,module,exports){
(function (process){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchStyle = exports.editStyle = exports.runStyle = exports.openStyle = exports.updateStyle = exports.initStyle = void 0;
const ActMnu = require("../../98.menu.unit/menu.action");
const ActBus = require("../../99.bus.unit/bus.action");
const ActSty = require("../style.action");
const ActVrt = require("../../act/vurt.action");
const ActDsk = require("../../act/disk.action");
var bit, val, idx, dex, lst, dat;
const initStyle = async (cpy, bal, ste) => {
    if (bal.dat != null)
        bit = await ste.hunt(ActBus.INIT_BUS, { idx: cpy.idx, lst: [ActSty], dat: bal.dat, src: bal.src });
    if (bal.val == 1)
        patch(ste, ActMnu.INIT_MENU, bal);
    if (bal.slv != null)
        bal.slv({ intBit: { idx: "init-style" } });
    return cpy;
};
exports.initStyle = initStyle;
const updateStyle = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    exec('tsc -b 109.style', async (err, stdout, stderr) => {
        if (err) {
            console.error(`exec error: ${err}`);
        }
        process.chdir("../999.vurt");
        bit = await ste.bus(ActVrt.BUNDLE_VURT, { src: "109.style" });
        process.chdir("../109.style");
        bit = await ste.bus(ActDsk.READ_DISK, { src: './work/109.style.js' });
        var style = bit.dskBit.dat;
        bit = await ste.bus(ActDsk.WRITE_DISK, { src: '../gillisse/public/jsx/109.style.js', dat: style });
        ...
        setTimeout(() => {
            if (bal.slv != null)
                bal.slv({ styBit: { idx: "update-style" } });
        }, 3);
    });
    return cpy;
};
exports.updateStyle = updateStyle;
const openStyle = async (cpy, bal, ste) => {
    bit = await ste.bus(ActDsk.COPY_DISK, { src: './vue', idx: '../gillisse/src' });
    bit = await ste.hunt(ActSty.RUN_STYLE, {});
    const open = require('open');
    var loc = './vrt.opn.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ styBit: { idx: "open-style" } });
    }, 33);
    return cpy;
};
exports.openStyle = openStyle;
const runStyle = async (cpy, bal, ste) => {
    const open = require('open');
    var loc = './vrt.gil.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ styBit: { idx: "run-style" } });
    });
    return cpy;
};
exports.runStyle = runStyle;
const editStyle = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    ...
    exec('start Code.exe ../packages/gillisse', async (err, stdout, stderr) => {
        ...
        process.chdir("../packages/109.style");
        if (bal.slv != null)
            bal.slv({ styBit: { idx: "edit-style", dat: {} } });
    });
    return cpy;
};
exports.editStyle = editStyle;
var patch = (ste, type, bale) => ste.dispatch({ type, bale });
const patchStyle = (cpy, bal, ste) => {
    debugger;
    return cpy;
};
...
},{"../../98.menu.unit/menu.action":36,"../../99.bus.unit/bus.action":41,"../../act/disk.action":49,"../../act/vurt.action":51,"../style.action":24,"_process":10,"child_process":undefined,"open":undefined}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PatchStyle = exports.PATCH_STYLE = exports.EditStyle = exports.EDIT_STYLE = exports.RunStyle = exports.RUN_STYLE = exports.OpenStyle = exports.OPEN_STYLE = exports.UpdateStyle = exports.UPDATE_STYLE = exports.InitStyle = exports.INIT_STYLE = void 0;
exports.INIT_STYLE = "[Style action] Init Style";
class InitStyle {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.INIT_STYLE;
    }
}
exports.InitStyle = InitStyle;
exports.UPDATE_STYLE = "[Style action] Update Style";
class UpdateStyle {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.UPDATE_STYLE;
    }
}
exports.UpdateStyle = UpdateStyle;
exports.OPEN_STYLE = "[Open action] Open Style";
class OpenStyle {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.OPEN_STYLE;
    }
}
exports.OpenStyle = OpenStyle;
exports.RUN_STYLE = "[Run action] Run Style";
class RunStyle {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RUN_STYLE;
    }
}
exports.RunStyle = RunStyle;
exports.EDIT_STYLE = "[Edit action] Edit Style";
class EditStyle {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.EDIT_STYLE;
    }
}
exports.EditStyle = EditStyle;
exports.PATCH_STYLE = "[Patch action] Patch Style";
class PatchStyle {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.PATCH_STYLE;
    }
}
exports.PatchStyle = PatchStyle;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchStyle = exports.editStyle = exports.runStyle = exports.openStyle = exports.updateStyle = exports.initStyle = void 0;
var style_buzz_1 = require("./buz/style.buzz");
Object.defineProperty(exports, "initStyle", { enumerable: true, get: function () { return style_buzz_1.initStyle; } });
var style_buzz_2 = require("./buz/style.buzz");
Object.defineProperty(exports, "updateStyle", { enumerable: true, get: function () { return style_buzz_2.updateStyle; } });
var style_buzz_3 = require("./buz/style.buzz");
Object.defineProperty(exports, "openStyle", { enumerable: true, get: function () { return style_buzz_3.openStyle; } });
var style_buzz_4 = require("./buz/style.buzz");
Object.defineProperty(exports, "runStyle", { enumerable: true, get: function () { return style_buzz_4.runStyle; } });
var style_buzz_5 = require("./buz/style.buzz");
Object.defineProperty(exports, "editStyle", { enumerable: true, get: function () { return style_buzz_5.editStyle; } });
var style_buzz_6 = require("./buz/style.buzz");
Object.defineProperty(exports, "patchStyle", { enumerable: true, get: function () { return style_buzz_6.patchStyle; } });

},{"./buz/style.buzz":23}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const Act = require("./style.action");
const style_model_1 = require("./style.model");
const Buzz = require("./style.buzzer");
function reducer(model = new style_model_1.StyleModel(), act, state) {
    switch (act.type) {
        case Act.UPDATE_STYLE:
            return Buzz.updateStyle(clone(model), act.bale, state);
        case Act.INIT_STYLE:
            return Buzz.initStyle(clone(model), act.bale, state);
        case Act.OPEN_STYLE:
            return Buzz.openStyle(clone(model), act.bale, state);
        case Act.RUN_STYLE:
            return Buzz.runStyle(clone(model), act.bale, state);
        case Act.EDIT_STYLE:
            return Buzz.editStyle(clone(model), act.bale, state);
        case Act.PATCH_STYLE:
            return Buzz.patchStyle(clone(model), act.bale, state);
        default:
            return model;
    }
}
...
},{"./style.action":24,"./style.buzzer":25,"./style.model":26,"clone-deep":3}],28:[function(require,module,exports){
"use strict";
...
let StyleUnit = class StyleUnit {
    constructor(state) {
    }
};
StyleUnit = __decorate([
    typescript_ioc_1.Singleton,
    __metadata("design:paramtypes", [state_1.default])
], StyleUnit);
exports.default = StyleUnit;
...
const ActSty = require("../../00.style.unit/style.action");
...
const updateMenu = async (cpy, bal, ste) => {
    ...
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "STYLE PIVOT V0", bit: 'local' });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
    var lst = [ActSty.UPDATE_STYLE, ActSty.OPEN_STYLE, ActSty.EDIT_STYLE];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActSty.OPEN_STYLE:
            bit = await ste.hunt(ActSty.OPEN_STYLE, {});
            break;
        case ActSty.UPDATE_STYLE:
            bit = await ste.hunt(ActSty.UPDATE_STYLE, {});
            break;
        case ActSty.EDIT_STYLE:
            bit = await ste.hunt(ActSty.EDIT_STYLE, {});
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "PATCHING...", bit: 'local' });
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
            lst = [ActSty.PATCH_STYLE];
            bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
            bit = await ste.hunt(ActSty.PATCH_STYLE, {});
            break;
        default:
...
},{"../../00.style.unit/style.action":24,"../../act/terminal.action":50}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const style_unit_1 = require("./00.style.unit/style.unit");
...
const style_model_1 = require("./00.style.unit/style.model");
...
exports.list = [style_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromStyle = require("./00.style.unit/style.reduce");
...
class UnitData {
    constructor() {
        this.style = new style_model_1.StyleModel();
...
},{"./00.style.unit/style.model":26,"./00.style.unit/style.reduce":27,"./00.style.unit/style.unit":28,"./97.collect.unit/collect.model":32,"./97.collect.unit/collect.reduce":33,"./97.collect.unit/collect.unit":34,"./98.menu.unit/menu.model":38,"./98.menu.unit/menu.reduce":39,"./98.menu.unit/menu.unit":40,"./99.bus.unit/bus.model":43,"./99.bus.unit/bus.reduce":44,"./99.bus.unit/bus.unit":45}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
