...
(function (global){(function (){
global.SPRITE = require("../dist/108.sprite/hunt");
global.SPRITE.ActSpr = require("../dist/108.sprite/00.sprite.unit/sprite.action");
...
},{"../dist/108.sprite/00.sprite.unit/sprite.action":24,"../dist/108.sprite/hunt":52}],23:[function(require,module,exports){
(function (process){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchSprite = exports.editSprite = exports.runSprite = exports.openSprite = exports.updateSprite = exports.initSprite = void 0;
const ActMnu = require("../../98.menu.unit/menu.action");
const ActBus = require("../../99.bus.unit/bus.action");
const ActSpr = require("../sprite.action");
const ActVrt = require("../../act/vurt.action");
const ActDsk = require("../../act/disk.action");
var bit, val, idx, dex, lst, dat;
const initSprite = async (cpy, bal, ste) => {
    console.log("init-sprite");
    if (bal.dat != null)
        bit = await ste.hunt(ActBus.INIT_BUS, { idx: cpy.idx, lst: [ActSpr], dat: bal.dat, src: bal.src });
    if (bal.val == 1)
        patch(ste, ActMnu.INIT_MENU, bal);
    if (bal.slv != null)
        bal.slv({ intBit: { idx: "init-sprite" } });
    return cpy;
};
exports.initSprite = initSprite;
const updateSprite = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    exec('tsc -b 108.sprite', async (err, stdout, stderr) => {
        if (err) {
            console.error(`exec error: ${err}`);
        }
        process.chdir("../999.vurt");
        bit = await ste.bus(ActVrt.BUNDLE_VURT, { src: "108.sprite" });
        process.chdir("../108.sprite");
        bit = await ste.bus(ActDsk.READ_DISK, { src: './work/108.sprite.js' });
        var sprite = bit.dskBit.dat;
        bit = await ste.bus(ActDsk.WRITE_DISK, { src: '../gillisse/public/jsx/108.sprite.js', dat: sprite });
        ...
        setTimeout(() => {
            if (bal.slv != null)
                bal.slv({ sprBit: { idx: "update-sprite" } });
        }, 3);
    });
    return cpy;
};
exports.updateSprite = updateSprite;
const openSprite = async (cpy, bal, ste) => {
    bit = await ste.bus(ActDsk.COPY_DISK, { src: './vue', idx: '../gillisse/src' });
    bit = await ste.hunt(ActSpr.RUN_SPRITE, {});
    const open = require('open');
    var loc = './vrt.opn.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ sprBit: { idx: "open-sprite" } });
    }, 33);
    return cpy;
};
exports.openSprite = openSprite;
const runSprite = async (cpy, bal, ste) => {
    const open = require('open');
    var loc = './vrt.gil.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ sprBit: { idx: "run-sprite" } });
    });
    return cpy;
};
exports.runSprite = runSprite;
const editSprite = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    ...
    exec('start Code.exe ../packages/gillisse', async (err, stdout, stderr) => {
        ...
        process.chdir("../packages/108.sprite");
        if (bal.slv != null)
            bal.slv({ sprBit: { idx: "edit-sprite", dat: {} } });
    });
    return cpy;
};
exports.editSprite = editSprite;
var patch = (ste, type, bale) => ste.dispatch({ type, bale });
const patchSprite = (cpy, bal, ste) => {
    debugger;
    return cpy;
};
exports.patchSprite = patchSprite;

}).call(this)}).call(this,require('_process'))
},{"../../98.menu.unit/menu.action":36,"../../99.bus.unit/bus.action":41,"../../act/disk.action":49,"../../act/vurt.action":51,"../sprite.action":24,"_process":10,"child_process":undefined,"open":undefined}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PatchSprite = exports.PATCH_SPRITE = exports.EditSprite = exports.EDIT_SPRITE = exports.RunSprite = exports.RUN_SPRITE = exports.OpenSprite = exports.OPEN_SPRITE = exports.UpdateSprite = exports.UPDATE_SPRITE = exports.InitSprite = exports.INIT_SPRITE = void 0;
...
exports.UpdateSprite = UpdateSprite;
exports.OPEN_SPRITE = "[Open action] Open Sprite";
class OpenSprite {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.OPEN_SPRITE;
    }
}
exports.OpenSprite = OpenSprite;
exports.RUN_SPRITE = "[Run action] Run Sprite";
class RunSprite {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RUN_SPRITE;
    }
}
exports.RunSprite = RunSprite;
exports.EDIT_SPRITE = "[Edit action] Edit Sprite";
class EditSprite {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.EDIT_SPRITE;
    }
}
exports.EditSprite = EditSprite;
exports.PATCH_SPRITE = "[Patch action] Patch Sprite";
class PatchSprite {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.PATCH_SPRITE;
    }
}
exports.PatchSprite = PatchSprite;
...
var sprite_buzz_3 = require("./buz/sprite.buzz");
Object.defineProperty(exports, "openSprite", { enumerable: true, get: function () { return sprite_buzz_3.openSprite; } });
var sprite_buzz_4 = require("./buz/sprite.buzz");
Object.defineProperty(exports, "runSprite", { enumerable: true, get: function () { return sprite_buzz_4.runSprite; } });
var sprite_buzz_5 = require("./buz/sprite.buzz");
Object.defineProperty(exports, "editSprite", { enumerable: true, get: function () { return sprite_buzz_5.editSprite; } });
var sprite_buzz_6 = require("./buz/sprite.buzz");
Object.defineProperty(exports, "patchSprite", { enumerable: true, get: function () { return sprite_buzz_6.patchSprite; } });

},{"./buz/sprite.buzz":23}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
function reducer(model = new sprite_model_1.SpriteModel(), act, state) {
    switch (act.type) {
        ...
        case Act.OPEN_SPRITE:
            return Buzz.openSprite(clone(model), act.bale, state);
        case Act.RUN_SPRITE:
            return Buzz.runSprite(clone(model), act.bale, state);
        case Act.EDIT_SPRITE:
            return Buzz.editSprite(clone(model), act.bale, state);
        case Act.PATCH_SPRITE:
            return Buzz.patchSprite(clone(model), act.bale, state);
        default:
            return model;
    }
}
...
},{"./sprite.action":24,"./sprite.buzzer":25,"./sprite.model":26,"clone-deep":3}],28:[function(require,module,exports){
"use strict";
...
const ActSpr = require("../../00.sprite.unit/sprite.action");
...
const updateMenu = async (cpy, bal, ste) => {
    ...
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "SPRITE PIVOT V0", bit: 'local' });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
    var lst = [ActSpr.UPDATE_SPRITE, ActSpr.OPEN_SPRITE, ActSpr.EDIT_SPRITE];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActSpr.OPEN_SPRITE:
            bit = await ste.hunt(ActSpr.OPEN_SPRITE, {});
            break;
        case ActSpr.UPDATE_SPRITE:
            bit = await ste.hunt(ActSpr.UPDATE_SPRITE, {});
            break;
        case ActSpr.EDIT_SPRITE:
            bit = await ste.hunt(ActSpr.EDIT_SPRITE, {});
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "PATCHING...", bit: 'local' });
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
            lst = [ActSpr.PATCH_SPRITE];
            bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
            bit = await ste.hunt(ActSpr.PATCH_SPRITE, {});
            break;
        default:
...
},{"../../00.sprite.unit/sprite.action":24,"../../act/terminal.action":50}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const sprite_unit_1 = require("./00.sprite.unit/sprite.unit");
...
const sprite_model_1 = require("./00.sprite.unit/sprite.model");
...
exports.list = [sprite_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromSprite = require("./00.sprite.unit/sprite.reduce");
