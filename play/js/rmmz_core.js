...
WebAudio.prototype._refreshSourceNode = function() {
    ...
    if (this._isPlaying) {
        const currentTime = WebAudio._currentTime();
        const offset = (currentTime - this._startTime) * this._pitch;
        this._startSourceNode(0, offset);
        this._removeEndTimer();
...
WebAudio.prototype._startSourceNode = function(when, offset) {
...
WebAudio.prototype._createSourceNode = function() {
    const currentTime = WebAudio._currentTime();
