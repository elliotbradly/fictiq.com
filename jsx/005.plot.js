...
(function (global){(function (){
global.PLOT = require("../dist/005.plot/hunt");
global.PLOT.ActPlt = require("../dist/005.plot/00.plot.unit/plot.action");
...
},{"../dist/005.plot/00.plot.unit/plot.action":24,"../dist/005.plot/hunt":52}],23:[function(require,module,exports){
(function (process){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchPlot = exports.editPlot = exports.runPlot = exports.openPlot = exports.updatePlot = exports.initPlot = void 0;
const ActMnu = require("../../98.menu.unit/menu.action");
const ActBus = require("../../99.bus.unit/bus.action");
const ActPlt = require("../plot.action");
const ActVrt = require("../../act/vurt.action");
const ActDsk = require("../../act/disk.action");
var bit, val, idx, dex, lst, dat;
const initPlot = async (cpy, bal, ste) => {
    if (bal.dat != null)
        bit = await ste.hunt(ActBus.INIT_BUS, { idx: cpy.idx, lst: [ActPlt], dat: bal.dat, src: bal.src });
    if (bal.val == 1)
        patch(ste, ActMnu.INIT_MENU, bal);
    if (bal.slv != null)
        bal.slv({ intBit: { idx: "init-plot" } });
    return cpy;
};
exports.initPlot = initPlot;
const updatePlot = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    exec('tsc -b 005.plot', async (err, stdout, stderr) => {
        if (err) {
            console.error(`exec error: ${err}`);
        }
        process.chdir("../999.vurt");
        bit = await ste.bus(ActVrt.BUNDLE_VURT, { src: "005.plot" });
        process.chdir("../005.plot");
        bit = await ste.bus(ActDsk.READ_DISK, { src: './work/005.plot.js' });
        var plot = bit.dskBit.dat;
        bit = await ste.bus(ActDsk.WRITE_DISK, { src: '../gillisse/public/jsx/005.plot.js', dat: plot });
        ...
        setTimeout(() => {
            if (bal.slv != null)
                bal.slv({ pltBit: { idx: "update-plot" } });
        }, 3);
    });
    return cpy;
};
...
const openPlot = async (cpy, bal, ste) => {
    ...
    bit = await ste.hunt(ActPlt.RUN_PLOT, {});
    const open = require('open');
    var loc = './vrt.opn.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ pltBit: { idx: "open-plot" } });
    }, 33);
    return cpy;
};
exports.openPlot = openPlot;
const runPlot = async (cpy, bal, ste) => {
    const open = require('open');
    var loc = './vrt.gil.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ pltBit: { idx: "run-plot" } });
    });
    return cpy;
};
exports.runPlot = runPlot;
const editPlot = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    ...
    exec('start Code.exe ../packages/gillisse', async (err, stdout, stderr) => {
        ...
        process.chdir("../packages/005.plot");
        if (bal.slv != null)
            bal.slv({ pltBit: { idx: "edit-plot", dat: {} } });
    });
    return cpy;
};
exports.editPlot = editPlot;
var patch = (ste, type, bale) => ste.dispatch({ type, bale });
const patchPlot = (cpy, bal, ste) => {
    debugger;
    return cpy;
};
exports.patchPlot = patchPlot;

}).call(this)}).call(this,require('_process'))
},{"../../98.menu.unit/menu.action":36,"../../99.bus.unit/bus.action":41,"../../act/disk.action":49,"../../act/vurt.action":51,"../plot.action":24,"_process":10,"child_process":undefined,"open":undefined}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PatchPlot = exports.PATCH_PLOT = exports.EditPlot = exports.EDIT_PLOT = exports.RunPlot = exports.RUN_PLOT = exports.OpenPlot = exports.OPEN_PLOT = exports.UpdatePlot = exports.UPDATE_PLOT = exports.InitPlot = exports.INIT_PLOT = void 0;
...
exports.OpenPlot = OpenPlot;
exports.RUN_PLOT = "[Run action] Run Plot";
class RunPlot {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RUN_PLOT;
    }
}
exports.RunPlot = RunPlot;
exports.EDIT_PLOT = "[Edit action] Edit Plot";
class EditPlot {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.EDIT_PLOT;
    }
}
exports.EditPlot = EditPlot;
exports.PATCH_PLOT = "[Patch action] Patch Plot";
class PatchPlot {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.PATCH_PLOT;
    }
}
exports.PatchPlot = PatchPlot;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchPlot = exports.editPlot = exports.runPlot = exports.openPlot = exports.updatePlot = exports.initPlot = void 0;
var plot_buzz_1 = require("./buz/plot.buzz");
Object.defineProperty(exports, "initPlot", { enumerable: true, get: function () { return plot_buzz_1.initPlot; } });
var plot_buzz_2 = require("./buz/plot.buzz");
Object.defineProperty(exports, "updatePlot", { enumerable: true, get: function () { return plot_buzz_2.updatePlot; } });
var plot_buzz_3 = require("./buz/plot.buzz");
Object.defineProperty(exports, "openPlot", { enumerable: true, get: function () { return plot_buzz_3.openPlot; } });
var plot_buzz_4 = require("./buz/plot.buzz");
Object.defineProperty(exports, "runPlot", { enumerable: true, get: function () { return plot_buzz_4.runPlot; } });
var plot_buzz_5 = require("./buz/plot.buzz");
Object.defineProperty(exports, "editPlot", { enumerable: true, get: function () { return plot_buzz_5.editPlot; } });
var plot_buzz_6 = require("./buz/plot.buzz");
Object.defineProperty(exports, "patchPlot", { enumerable: true, get: function () { return plot_buzz_6.patchPlot; } });

},{"./buz/plot.buzz":23}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PlotModel = void 0;
class PlotModel {
    constructor() {
        this.idx = '005.plot';
    }
...
function reducer(model = new plot_model_1.PlotModel(), act, state) {
    switch (act.type) {
        ...
        case Act.RUN_PLOT:
            return Buzz.runPlot(clone(model), act.bale, state);
        case Act.EDIT_PLOT:
            return Buzz.editPlot(clone(model), act.bale, state);
        case Act.PATCH_PLOT:
            return Buzz.patchPlot(clone(model), act.bale, state);
        default:
            return model;
    }
}
...
},{"./plot.action":24,"./plot.buzzer":25,"./plot.model":26,"clone-deep":3}],28:[function(require,module,exports){
"use strict";
...
const ActPlt = require("../../00.plot.unit/plot.action");
...
const updateMenu = async (cpy, bal, ste) => {
    ...
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "PLOT PIVOT V0", bit: 'local' });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
    var lst = [ActPlt.UPDATE_PLOT, ActPlt.OPEN_PLOT, ActPlt.EDIT_PLOT];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActPlt.OPEN_PLOT:
            bit = await ste.hunt(ActPlt.OPEN_PLOT, {});
            break;
        case ActPlt.UPDATE_PLOT:
            bit = await ste.hunt(ActPlt.UPDATE_PLOT, {});
            break;
        case ActPlt.EDIT_PLOT:
            bit = await ste.hunt(ActPlt.EDIT_PLOT, {});
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "PATCHING...", bit: 'local' });
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
            lst = [ActPlt.PATCH_PLOT];
            bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
            bit = await ste.hunt(ActPlt.PATCH_PLOT, {});
            break;
        default:
...
},{"../../00.plot.unit/plot.action":24,"../../act/terminal.action":50}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const plot_unit_1 = require("./00.plot.unit/plot.unit");
...
const plot_model_1 = require("./00.plot.unit/plot.model");
...
exports.list = [plot_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromPlot = require("./00.plot.unit/plot.reduce");
...
},{"./00.plot.unit/plot.model":26,"./00.plot.unit/plot.reduce":27,"./00.plot.unit/plot.unit":28,"./97.collect.unit/collect.model":32,"./97.collect.unit/collect.reduce":33,"./97.collect.unit/collect.unit":34,"./98.menu.unit/menu.model":38,"./98.menu.unit/menu.reduce":39,"./98.menu.unit/menu.unit":40,"./99.bus.unit/bus.model":43,"./99.bus.unit/bus.reduce":44,"./99.bus.unit/bus.unit":45}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
