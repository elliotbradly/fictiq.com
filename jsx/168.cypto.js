...
(function (global){(function (){
global.CYPTO = require("../dist/168.cypto/hunt");
global.CYPTO.ActCyp = require("../dist/168.cypto/00.cypto.unit/cypto.action");
...
},{"../dist/168.cypto/00.cypto.unit/cypto.action":24,"../dist/168.cypto/hunt":52}],23:[function(require,module,exports){
(function (process){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchCypto = exports.editCypto = exports.runCypto = exports.openCypto = exports.updateCypto = exports.initCypto = void 0;
const ActMnu = require("../../98.menu.unit/menu.action");
const ActBus = require("../../99.bus.unit/bus.action");
const ActCyp = require("../cypto.action");
const ActVrt = require("../../act/vurt.action");
const ActDsk = require("../../act/disk.action");
var bit, val, idx, dex, lst, dat;
const initCypto = async (cpy, bal, ste) => {
    if (bal.dat != null)
        bit = await ste.hunt(ActBus.INIT_BUS, { idx: cpy.idx, lst: [ActCyp], dat: bal.dat, src: bal.src });
    if (bal.val == 1)
        patch(ste, ActMnu.INIT_MENU, bal);
    if (bal.slv != null)
        bal.slv({ intBit: { idx: "init-cypto" } });
    return cpy;
};
exports.initCypto = initCypto;
const updateCypto = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    exec('tsc -b 168.cypto', async (err, stdout, stderr) => {
        if (err) {
            console.error(`exec error: ${err}`);
        }
        process.chdir("../999.vurt");
        bit = await ste.bus(ActVrt.BUNDLE_VURT, { src: "168.cypto" });
        process.chdir("../168.cypto");
        bit = await ste.bus(ActDsk.READ_DISK, { src: './work/168.cypto.js' });
        var cypto = bit.dskBit.dat;
        bit = await ste.bus(ActDsk.WRITE_DISK, { src: '../gillisse/public/jsx/168.cypto.js', dat: cypto });
        ...
        setTimeout(() => {
            if (bal.slv != null)
                bal.slv({ cypBit: { idx: "update-cypto" } });
        }, 3);
    });
    return cpy;
};
exports.updateCypto = updateCypto;
const openCypto = async (cpy, bal, ste) => {
    bit = await ste.bus(ActDsk.COPY_DISK, { src: './vue', idx: '../gillisse/src' });
    bit = await ste.hunt(ActCyp.RUN_CYPTO, {});
    const open = require('open');
    var loc = './vrt.opn.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ cypBit: { idx: "open-cypto" } });
    }, 33);
    return cpy;
};
exports.openCypto = openCypto;
const runCypto = async (cpy, bal, ste) => {
    const open = require('open');
    var loc = './vrt.gil.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ cypBit: { idx: "run-cypto" } });
    });
    return cpy;
};
exports.runCypto = runCypto;
const editCypto = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    ...
    exec('start Code.exe ../packages/gillisse', async (err, stdout, stderr) => {
        ...
        process.chdir("../packages/168.cypto");
        if (bal.slv != null)
            bal.slv({ cypBit: { idx: "edit-cypto", dat: {} } });
    });
    return cpy;
};
exports.editCypto = editCypto;
var patch = (ste, type, bale) => ste.dispatch({ type, bale });
const patchCypto = (cpy, bal, ste) => {
    debugger;
    return cpy;
};
exports.patchCypto = patchCypto;

}).call(this)}).call(this,require('_process'))
},{"../../98.menu.unit/menu.action":36,"../../99.bus.unit/bus.action":41,"../../act/disk.action":49,"../../act/vurt.action":51,"../cypto.action":24,"_process":10,"child_process":undefined,"open":undefined}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PatchCypto = exports.PATCH_CYPTO = exports.EditCypto = exports.EDIT_CYPTO = exports.RunCypto = exports.RUN_CYPTO = exports.OpenCypto = exports.OPEN_CYPTO = exports.UpdateCypto = exports.UPDATE_CYPTO = exports.InitCypto = exports.INIT_CYPTO = void 0;
exports.INIT_CYPTO = "[Cypto action] Init Cypto";
class InitCypto {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.INIT_CYPTO;
    }
}
exports.InitCypto = InitCypto;
exports.UPDATE_CYPTO = "[Cypto action] Update Cypto";
class UpdateCypto {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.UPDATE_CYPTO;
    }
}
exports.UpdateCypto = UpdateCypto;
exports.OPEN_CYPTO = "[Open action] Open Cypto";
class OpenCypto {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.OPEN_CYPTO;
    }
}
exports.OpenCypto = OpenCypto;
exports.RUN_CYPTO = "[Run action] Run Cypto";
class RunCypto {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RUN_CYPTO;
    }
}
exports.RunCypto = RunCypto;
exports.EDIT_CYPTO = "[Edit action] Edit Cypto";
class EditCypto {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.EDIT_CYPTO;
    }
}
exports.EditCypto = EditCypto;
exports.PATCH_CYPTO = "[Patch action] Patch Cypto";
class PatchCypto {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.PATCH_CYPTO;
    }
}
exports.PatchCypto = PatchCypto;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchCypto = exports.editCypto = exports.runCypto = exports.openCypto = exports.updateCypto = exports.initCypto = void 0;
var cypto_buzz_1 = require("./buz/cypto.buzz");
Object.defineProperty(exports, "initCypto", { enumerable: true, get: function () { return cypto_buzz_1.initCypto; } });
var cypto_buzz_2 = require("./buz/cypto.buzz");
Object.defineProperty(exports, "updateCypto", { enumerable: true, get: function () { return cypto_buzz_2.updateCypto; } });
var cypto_buzz_3 = require("./buz/cypto.buzz");
Object.defineProperty(exports, "openCypto", { enumerable: true, get: function () { return cypto_buzz_3.openCypto; } });
var cypto_buzz_4 = require("./buz/cypto.buzz");
Object.defineProperty(exports, "runCypto", { enumerable: true, get: function () { return cypto_buzz_4.runCypto; } });
var cypto_buzz_5 = require("./buz/cypto.buzz");
Object.defineProperty(exports, "editCypto", { enumerable: true, get: function () { return cypto_buzz_5.editCypto; } });
var cypto_buzz_6 = require("./buz/cypto.buzz");
Object.defineProperty(exports, "patchCypto", { enumerable: true, get: function () { return cypto_buzz_6.patchCypto; } });

},{"./buz/cypto.buzz":23}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.CyptoModel = void 0;
class CyptoModel {
    constructor() {
        this.idx = '168.cypto';
    }
}
exports.CyptoModel = CyptoModel;
...
const Act = require("./cypto.action");
const cypto_model_1 = require("./cypto.model");
const Buzz = require("./cypto.buzzer");
function reducer(model = new cypto_model_1.CyptoModel(), act, state) {
    switch (act.type) {
        case Act.UPDATE_CYPTO:
            return Buzz.updateCypto(clone(model), act.bale, state);
        case Act.INIT_CYPTO:
            return Buzz.initCypto(clone(model), act.bale, state);
        case Act.OPEN_CYPTO:
            return Buzz.openCypto(clone(model), act.bale, state);
        case Act.RUN_CYPTO:
            return Buzz.runCypto(clone(model), act.bale, state);
        case Act.EDIT_CYPTO:
            return Buzz.editCypto(clone(model), act.bale, state);
        case Act.PATCH_CYPTO:
            return Buzz.patchCypto(clone(model), act.bale, state);
        default:
            return model;
    }
}
...
},{"./cypto.action":24,"./cypto.buzzer":25,"./cypto.model":26,"clone-deep":3}],28:[function(require,module,exports){
"use strict";
...
let CyptoUnit = class CyptoUnit {
    constructor(state) {
    }
};
CyptoUnit = __decorate([
    typescript_ioc_1.Singleton,
    __metadata("design:paramtypes", [state_1.default])
], CyptoUnit);
exports.default = CyptoUnit;
...
const ActCyp = require("../../00.cypto.unit/cypto.action");
...
const updateMenu = async (cpy, bal, ste) => {
    ...
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "CYPTO PIVOT V0", bit: 'local' });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
    var lst = [ActCyp.UPDATE_CYPTO, ActCyp.OPEN_CYPTO, ActCyp.EDIT_CYPTO];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActCyp.OPEN_CYPTO:
            bit = await ste.hunt(ActCyp.OPEN_CYPTO, {});
            break;
        case ActCyp.UPDATE_CYPTO:
            bit = await ste.hunt(ActCyp.UPDATE_CYPTO, {});
            break;
        case ActCyp.EDIT_CYPTO:
            bit = await ste.hunt(ActCyp.EDIT_CYPTO, {});
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "PATCHING...", bit: 'local' });
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
            lst = [ActCyp.PATCH_CYPTO];
            bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
            bit = await ste.hunt(ActCyp.PATCH_CYPTO, {});
            break;
        default:
...
},{"../../00.cypto.unit/cypto.action":24,"../../act/terminal.action":50}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const cypto_unit_1 = require("./00.cypto.unit/cypto.unit");
...
const cypto_model_1 = require("./00.cypto.unit/cypto.model");
...
exports.list = [cypto_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromCypto = require("./00.cypto.unit/cypto.reduce");
...
class UnitData {
    constructor() {
        this.cypto = new cypto_model_1.CyptoModel();
...
},{"./00.cypto.unit/cypto.model":26,"./00.cypto.unit/cypto.reduce":27,"./00.cypto.unit/cypto.unit":28,"./97.collect.unit/collect.model":32,"./97.collect.unit/collect.reduce":33,"./97.collect.unit/collect.unit":34,"./98.menu.unit/menu.model":38,"./98.menu.unit/menu.reduce":39,"./98.menu.unit/menu.unit":40,"./99.bus.unit/bus.model":43,"./99.bus.unit/bus.reduce":44,"./99.bus.unit/bus.unit":45}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
