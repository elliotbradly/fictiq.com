...
},{"is-plain-object":6,"kind-of":8,"shallow-clone":14}],4:[function(require,module,exports){
// doT.js
...
},{"../model":24,"./injection-handler":22,"lodash.get":9,"lodash.set":10}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./container/container":21,"./model":24,"reflect-metadata":12}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
},{"./container/container":21,"./decorators":23,"./model":24,"./scopes":25,"reflect-metadata":12}],27:[function(require,module,exports){
(function (global){(function (){
global.SYMBOL = require("../dist/111.symbol/hunt");
global.SYMBOL.ActSym = require("../dist/111.symbol/00.symbol.unit/symbol.action");

}).call(this)}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../dist/111.symbol/00.symbol.unit/symbol.action":29,"../dist/111.symbol/hunt":57}],28:[function(require,module,exports){
(function (process){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.pageSymbol = exports.editSymbol = exports.bodySymbol = exports.renderSymbol = exports.modelSymbol = exports.updateSymbol = exports.browserSymbol = exports.runSymbol = exports.openSymbol = exports.initSymbol = void 0;
const ActMnu = require("../../98.menu.unit/menu.action");
const ActBus = require("../../99.bus.unit/bus.action");
const ActSym = require("../../00.symbol.unit/symbol.action");
const ActDsk = require("../../act/disk.action");
const ActVrt = require("../../act/vurt.action");
var bit, val, idx, dex, lst, dat, src;
const initSymbol = async (cpy, bal, ste) => {
    //if (typeof window == "object") debugger
    bit = await ste.hunt(ActBus.INIT_BUS, { idx: cpy.idx, lst: [ActSym], dat: bal.dat, src: bal.src });
    ste.bus("[Ready action] Ready Play", {});
    if (bal.val == 1)
        patch(ste, ActMnu.INIT_MENU, bal);
    if (bal.slv != null)
        bal.slv({ intBit: { idx: "init-symbol" } });
    return cpy;
};
exports.initSymbol = initSymbol;
const openSymbol = async (cpy, bal, ste) => {
    bit = await ste.hunt(ActSym.RUN_SYMBOL, {});
    const open = require('open');
    var loc = './vrt.opn.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ shdBit: { idx: "open-symbol" } });
    }, 33);
    return cpy;
};
exports.openSymbol = openSymbol;
const runSymbol = async (cpy, bal, ste) => {
    bit = ste.hunt(ActSym);
    const open = require('open');
    var loc = './vrt.vew.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ shdBit: { idx: "run-symbol" } });
    });
    return cpy;
};
exports.runSymbol = runSymbol;
const browserSymbol = async (cpy, bal, ste) => {
    const open = require('open');
    var loc = 'http://localhost:3333/';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ shdBit: { idx: "browser-symbol" } });
    }, 33);
    return cpy;
};
exports.browserSymbol = browserSymbol;
const updateSymbol = async (cpy, bal, ste) => {
    const { exec } = require('child_process');
    exec('tsc -b 111.symbol', async (err, stdout, stderr) => {
        if (err) {
            console.error(`exec error: ${err}`);
        }
        process.chdir("../999.vurt");
        bit = await ste.bus(ActVrt.BUNDLE_VURT, { src: "111.symbol" });
        process.chdir("../111.symbol");
        bit = await ste.bus(ActDsk.READ_DISK, { src: './work/111.symbol.js' });
        var symbol = bit.dskBit.dat;
        bit = await ste.bus(ActDsk.WRITE_DISK, { src: '../gillisse/public/jsx/111.symbol.js', dat: symbol });
        ...
        setTimeout(() => {
            if (bal.slv != null)
                bal.slv({ symBit: { idx: "update-symbol" } });
        }, 3);
    });
    return cpy;
};
exports.updateSymbol = updateSymbol;
const modelSymbol = async (cpy, bal, ste) => {
    dat = `
    import Minimal from "../fce/Minimal.interface";

    export class MinimalVewModel implements Minimal {
        {{=it.model}}
    }    
    `;
    bit = await ste.bus(ActDsk.LIST_DISK, { src: bal.src });
    lst = bit.dskBit.lst;
    dex = 0;
    var content = [];
    const fin = async (lst) => {
        ...
        var model = output.join("\n");
        var writeLine = [];
        var lineList = dat.split("\n");
        var gel = { model };
        ...
        var master = writeLine.join("\n");
        src = "./111.symbol/01.minimal.unit/mod/minimal.vew.mod.ts";
        bit = await ste.bus(ActDsk.WRITE_DISK, { src, dat: master });
        if (bal.slv != null)
            bal.slv({ symBit: { idx: "model-symbol", lst: writeLine } });
    };
    const next = async () => {
        var now = lst[dex];
        src = bal.src + now;
        idx = S(now.split(".")[0]).camelize().s;
        var modBit = await ste.bus(ActDsk.READ_DISK, { src });
        var lstLine = modBit.dskBit.lst;
        var tmp = [idx + ":string = `", "`;"];
        lstLine.forEach((b, c) => {
            tmp.splice(c + 1, 0, b);
        });
...
exports.modelSymbol = modelSymbol;
const renderSymbol = (cpy, bal, ste) => {
    debugger;
    //var minMod: MinimalModel = ste.value.minimal;
    //var gel = {};
    //for (var key in minMod.vew) {
    //  gel[key] = minMod.vew[key];
    // }
    //var out = [];
    //minMod.vew.index.split("\n").forEach((a, b) => {
    //  console.log("line " + a);
...
const bodySymbol = (cpy, bal, ste) => {
    ...
    if (bal.slv != null)
        bal.slv({ symBit: { idx: "body-symbol", src: bal.src, dat: out.join('\n') } });
    return cpy;
};
exports.bodySymbol = bodySymbol;
const editSymbol = async (cpy, bal, ste) => {
    const open = require('open');
    var loc = './vrt.gil.bat';
    bit = await open(loc);
    if (bal.slv != null)
...
exports.editSymbol = editSymbol;
const pageSymbol = (cpy, bal, ste) => {
    document.location.href = bal.src;
    if (bal.slv != null)
        bal.slv({ symBit: { idx: "page-symbol", dat: {} } });
    return cpy;
};
exports.pageSymbol = pageSymbol;
var patch = (ste, type, bale) => ste.dispatch({ type, bale });
const doT = require("dot");
const S = require("string");

}).call(this)}).call(this,require('_process'))
},{"../../00.symbol.unit/symbol.action":29,"../../98.menu.unit/menu.action":41,"../../99.bus.unit/bus.action":46,"../../act/disk.action":54,"../../act/vurt.action":56,"_process":11,"child_process":undefined,"dot":4,"open":undefined,"string":18}],29:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.RunSymbol = exports.RUN_SYMBOL = exports.BrowserSymbol = exports.BROWSER_SYMBOL = exports.PageSymbol = exports.PAGE_SYMBOL = exports.EditSymbol = exports.EDIT_SYMBOL = exports.BodySymbol = exports.BODY_SYMBOL = exports.RenderSymbol = exports.RENDER_SYMBOL = exports.ModelSymbol = exports.MODEL_SYMBOL = exports.OpenSymbol = exports.OPEN_SYMBOL = exports.UpdateSymbol = exports.UPDATE_SYMBOL = exports.InitSymbol = exports.INIT_SYMBOL = void 0;
// Symbol actions
exports.INIT_SYMBOL = "[Symbol action] Init Symbol";
class InitSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.INIT_SYMBOL;
    }
}
exports.InitSymbol = InitSymbol;
exports.UPDATE_SYMBOL = "[Symbol action] Update Symbol";
class UpdateSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.UPDATE_SYMBOL;
    }
}
exports.UpdateSymbol = UpdateSymbol;
exports.OPEN_SYMBOL = "[Open action] Open Symbol";
class OpenSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.OPEN_SYMBOL;
    }
}
exports.OpenSymbol = OpenSymbol;
exports.MODEL_SYMBOL = "[Model action] Model Symbol";
class ModelSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.MODEL_SYMBOL;
    }
}
exports.ModelSymbol = ModelSymbol;
exports.RENDER_SYMBOL = "[Render action] Render Symbol";
class RenderSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RENDER_SYMBOL;
    }
}
exports.RenderSymbol = RenderSymbol;
exports.BODY_SYMBOL = "[Body action] Body Symbol";
class BodySymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.BODY_SYMBOL;
    }
}
exports.BodySymbol = BodySymbol;
exports.EDIT_SYMBOL = "[Edit action] Edit Symbol";
class EditSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.EDIT_SYMBOL;
    }
}
exports.EditSymbol = EditSymbol;
exports.PAGE_SYMBOL = "[Page action] Page Symbol";
class PageSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.PAGE_SYMBOL;
    }
}
exports.PageSymbol = PageSymbol;
exports.BROWSER_SYMBOL = "[Browser action] Browser Symbol";
class BrowserSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.BROWSER_SYMBOL;
    }
}
exports.BrowserSymbol = BrowserSymbol;
exports.RUN_SYMBOL = "[Run action] Run Symbol";
class RunSymbol {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RUN_SYMBOL;
    }
}
exports.RunSymbol = RunSymbol;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.runSymbol = exports.browserSymbol = exports.pageSymbol = exports.editSymbol = exports.bodySymbol = exports.renderSymbol = exports.modelSymbol = exports.openSymbol = exports.updateSymbol = exports.initSymbol = void 0;
var symbol_buzz_1 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "initSymbol", { enumerable: true, get: function () { return symbol_buzz_1.initSymbol; } });
var symbol_buzz_2 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "updateSymbol", { enumerable: true, get: function () { return symbol_buzz_2.updateSymbol; } });
var symbol_buzz_3 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "openSymbol", { enumerable: true, get: function () { return symbol_buzz_3.openSymbol; } });
var symbol_buzz_4 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "modelSymbol", { enumerable: true, get: function () { return symbol_buzz_4.modelSymbol; } });
var symbol_buzz_5 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "renderSymbol", { enumerable: true, get: function () { return symbol_buzz_5.renderSymbol; } });
var symbol_buzz_6 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "bodySymbol", { enumerable: true, get: function () { return symbol_buzz_6.bodySymbol; } });
var symbol_buzz_7 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "editSymbol", { enumerable: true, get: function () { return symbol_buzz_7.editSymbol; } });
var symbol_buzz_8 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "pageSymbol", { enumerable: true, get: function () { return symbol_buzz_8.pageSymbol; } });
var symbol_buzz_9 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "browserSymbol", { enumerable: true, get: function () { return symbol_buzz_9.browserSymbol; } });
var symbol_buzz_10 = require("./buz/symbol.buzz");
Object.defineProperty(exports, "runSymbol", { enumerable: true, get: function () { return symbol_buzz_10.runSymbol; } });

},{"./buz/symbol.buzz":28}],31:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const Act = require("./symbol.action");
const symbol_model_1 = require("./symbol.model");
const Buzz = require("./symbol.buzzer");
function reducer(model = new symbol_model_1.SymbolModel(), act, state) {
    switch (act.type) {
        case Act.UPDATE_SYMBOL:
            return Buzz.updateSymbol(clone(model), act.bale, state);
        case Act.INIT_SYMBOL:
            return Buzz.initSymbol(clone(model), act.bale, state);
        case Act.OPEN_SYMBOL:
            return Buzz.openSymbol(clone(model), act.bale, state);
        case Act.MODEL_SYMBOL:
            return Buzz.modelSymbol(clone(model), act.bale, state);
        case Act.RENDER_SYMBOL:
            return Buzz.renderSymbol(clone(model), act.bale, state);
        case Act.BODY_SYMBOL:
            return Buzz.bodySymbol(clone(model), act.bale, state);
        case Act.EDIT_SYMBOL:
            return Buzz.editSymbol(clone(model), act.bale, state);
        case Act.PAGE_SYMBOL:
            return Buzz.pageSymbol(clone(model), act.bale, state);
        case Act.BROWSER_SYMBOL:
            return Buzz.browserSymbol(clone(model), act.bale, state);
        case Act.RUN_SYMBOL:
            return Buzz.runSymbol(clone(model), act.bale, state);
        default:
            return model;
    }
}
...
},{"./symbol.action":29,"./symbol.buzzer":30,"./symbol.model":31,"clone-deep":3}],33:[function(require,module,exports){
"use strict";
...
let SymbolUnit = class SymbolUnit {
    constructor(state) {
    }
};
SymbolUnit = __decorate([
    typescript_ioc_1.Singleton,
    __metadata("design:paramtypes", [state_1.default])
], SymbolUnit);
exports.default = SymbolUnit;

},{"../99.core/state":52,"typescript-ioc":26}],34:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const writeCollect = async (cpy, bal, ste) => {
    ...
    if (cabBit.bits[bal.idx] == null) {
        ...
        cabBit.bitList[cabBit.bits[bal.idx]] = dat;
    }
...
},{"../../97.collect.unit/collect.action":35}],35:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./buz/collect.buzz":34}],37:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./collect.action":35,"./collect.buzzer":36,"./collect.model":37,"clone-deep":3}],39:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../99.core/state":52,"typescript-ioc":26}],40:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const updateMenu = async (cpy, bal, ste) => {
    ...
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "Symbol PIVOT V0" });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------" });
    var lst = [ActSym.OPEN_SYMBOL, ActSym.UPDATE_SYMBOL, ActSym.BROWSER_SYMBOL, ActSym.RUN_SYMBOL, ActSym.EDIT_SYMBOL];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActSym.OPEN_SYMBOL:
            bit = await ste.hunt(ActSym.OPEN_SYMBOL, {});
            break;
        case ActSym.RUN_SYMBOL:
            bit = await ste.hunt(ActSym.RUN_SYMBOL, {});
            break;
        case ActSym.BROWSER_SYMBOL:
            bit = await ste.hunt(ActSym.BROWSER_SYMBOL, {});
            break;
        case ActSym.EDIT_SYMBOL:
            bit = await ste.hunt(ActSym.EDIT_SYMBOL, {});
            break;
        case ActSym.UPDATE_SYMBOL:
            bit = await ste.hunt(ActSym.UPDATE_SYMBOL, {});
            break;
        default:
...
},{"../../00.symbol.unit/symbol.action":29,"../../act/terminal.action":55}],41:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.CloseMenu = exports.CLOSE_MENU = exports.TestMenu = exports.TEST_MENU = exports.UpdateMenu = exports.UPDATE_MENU = exports.InitMenu = exports.INIT_MENU = void 0;
...
},{"./buz/menu.buzz":40}],43:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./menu.action":41,"./menu.buzzer":42,"./menu.model":43,"clone-deep":3}],45:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../99.core/state":52,"typescript-ioc":26}],46:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./buz/bus.buzz":51}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./bus.action":46,"./bus.buzzer":47,"./bus.model":48,"clone-deep":3}],50:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../99.core/state":52,"typescript-ioc":26}],51:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../../97.collect.unit/collect.action":35,"../../98.menu.unit/menu.action":41,"../../99.bus.unit/bus.action":46,"clone-deep":3}],52:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../BEE":53,"rx-lite":13}],53:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.reducer = exports.list = void 0;
const symbol_unit_1 = require("./00.symbol.unit/symbol.unit");
...
const symbol_model_1 = require("./00.symbol.unit/symbol.model");
...
exports.list = [symbol_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromSymbol = require("./00.symbol.unit/symbol.reduce");
...
exports.reducer = {
    symbol: reduceFromSymbol.reducer,
...
class UnitData {
    constructor() {
        this.symbol = new symbol_model_1.SymbolModel();
...
},{"./00.symbol.unit/symbol.model":31,"./00.symbol.unit/symbol.reduce":32,"./00.symbol.unit/symbol.unit":33,"./97.collect.unit/collect.model":37,"./97.collect.unit/collect.reduce":38,"./97.collect.unit/collect.unit":39,"./98.menu.unit/menu.model":43,"./98.menu.unit/menu.reduce":44,"./98.menu.unit/menu.unit":45,"./99.bus.unit/bus.model":48,"./99.bus.unit/bus.reduce":49,"./99.bus.unit/bus.unit":50}],54:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
