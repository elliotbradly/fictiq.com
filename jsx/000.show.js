...
(function (global){(function (){
global.SHOW = require("../dist/000.show/hunt");
global.SHOW.ActShw = require("../dist/000.show/00.show.unit/show.action");
...
},{"../dist/000.show/00.show.unit/show.action":24,"../dist/000.show/hunt":52}],23:[function(require,module,exports){
(function (process){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchShow = exports.editShow = exports.runShow = exports.openShow = exports.updateShow = exports.initShow = void 0;
...
const initShow = async (cpy, bal, ste) => {
    if (bal.dat != null)
        bit = await ste.hunt(ActBus.INIT_BUS, { idx: cpy.idx, lst: [ActShw], dat: bal.dat, src: bal.src });
    if (bal.val == 1)
        patch(ste, ActMnu.INIT_MENU, bal);
    if (bal.slv != null)
        bal.slv({ intBit: { idx: "init-show" } });
    return cpy;
};
exports.initShow = initShow;
const updateShow = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    exec('tsc -b 000.show', async (err, stdout, stderr) => {
        if (err) {
            console.error(`exec error: ${err}`);
        }
        process.chdir("../999.vurt");
        bit = await ste.bus(ActVrt.BUNDLE_VURT, { src: "000.show" });
        process.chdir("../000.show");
        bit = await ste.bus(ActDsk.READ_DISK, { src: './work/000.show.js' });
        var show = bit.dskBit.dat;
        bit = await ste.bus(ActDsk.WRITE_DISK, { src: '../gillisse/public/jsx/000.show.js', dat: show });
        ...
        setTimeout(() => {
            if (bal.slv != null)
                bal.slv({ shwBit: { idx: "update-show" } });
        }, 3);
    });
    return cpy;
};
...
const openShow = async (cpy, bal, ste) => {
    ...
    bit = await ste.hunt(ActShw.RUN_SHOW, {});
    const open = require('open');
    var loc = './vrt.opn.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ shwBit: { idx: "open-show" } });
    }, 33);
    return cpy;
};
exports.openShow = openShow;
const runShow = async (cpy, bal, ste) => {
    const open = require('open');
    var loc = './vrt.gil.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ shwBit: { idx: "run-show" } });
    });
    return cpy;
};
exports.runShow = runShow;
const editShow = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    ...
    exec('start Code.exe ../packages/gillisse', async (err, stdout, stderr) => {
        ...
        process.chdir("../packages/000.show");
        if (bal.slv != null)
            bal.slv({ shwBit: { idx: "edit-show", dat: {} } });
    });
    return cpy;
};
exports.editShow = editShow;
var patch = (ste, type, bale) => ste.dispatch({ type, bale });
const patchShow = (cpy, bal, ste) => {
    debugger;
    return cpy;
};
exports.patchShow = patchShow;

}).call(this)}).call(this,require('_process'))
},{"../../98.menu.unit/menu.action":36,"../../99.bus.unit/bus.action":41,"../../act/disk.action":49,"../../act/vurt.action":51,"../show.action":24,"_process":10,"child_process":undefined,"open":undefined}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PatchShow = exports.PATCH_SHOW = exports.EditShow = exports.EDIT_SHOW = exports.RunShow = exports.RUN_SHOW = exports.OpenShow = exports.OPEN_SHOW = exports.UpdateShow = exports.UPDATE_SHOW = exports.InitShow = exports.INIT_SHOW = void 0;
...
exports.OpenShow = OpenShow;
exports.RUN_SHOW = "[Run action] Run Show";
class RunShow {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RUN_SHOW;
    }
}
exports.RunShow = RunShow;
exports.EDIT_SHOW = "[Edit action] Edit Show";
class EditShow {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.EDIT_SHOW;
    }
}
exports.EditShow = EditShow;
exports.PATCH_SHOW = "[Patch action] Patch Show";
class PatchShow {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.PATCH_SHOW;
    }
}
exports.PatchShow = PatchShow;
...
Object.defineProperty(exports, "runShow", { enumerable: true, get: function () { return show_buzz_4.runShow; } });
var show_buzz_5 = require("./buz/show.buzz");
Object.defineProperty(exports, "editShow", { enumerable: true, get: function () { return show_buzz_5.editShow; } });
var show_buzz_6 = require("./buz/show.buzz");
Object.defineProperty(exports, "patchShow", { enumerable: true, get: function () { return show_buzz_6.patchShow; } });

},{"./buz/show.buzz":23}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
function reducer(model = new show_model_1.ShowModel(), act, state) {
    switch (act.type) {
        ...
        case Act.RUN_SHOW:
            return Buzz.runShow(clone(model), act.bale, state);
        case Act.EDIT_SHOW:
            return Buzz.editShow(clone(model), act.bale, state);
        case Act.PATCH_SHOW:
            return Buzz.patchShow(clone(model), act.bale, state);
        default:
            return model;
    }
}
...
},{"./show.action":24,"./show.buzzer":25,"./show.model":26,"clone-deep":3}],28:[function(require,module,exports){
"use strict";
...
const ActShw = require("../../00.show.unit/show.action");
...
const updateMenu = async (cpy, bal, ste) => {
    ...
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "SHOW PIVOT V0", bit: 'local' });
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
    var lst = [ActShw.UPDATE_SHOW, ActShw.OPEN_SHOW, ActShw.EDIT_SHOW];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActShw.OPEN_SHOW:
            bit = await ste.hunt(ActShw.OPEN_SHOW, {});
            break;
        case ActShw.UPDATE_SHOW:
            bit = await ste.hunt(ActShw.UPDATE_SHOW, {});
            break;
        case ActShw.EDIT_SHOW:
            bit = await ste.hunt(ActShw.EDIT_SHOW, {});
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "PATCHING...", bit: 'local' });
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
            lst = [ActShw.PATCH_SHOW];
            bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
            bit = await ste.hunt(ActShw.PATCH_SHOW, {});
            break;
        default:
...
},{"../../00.show.unit/show.action":24,"../../act/terminal.action":50}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const show_unit_1 = require("./00.show.unit/show.unit");
...
const show_model_1 = require("./00.show.unit/show.model");
...
exports.list = [show_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromShow = require("./00.show.unit/show.reduce");
...
},{"./00.show.unit/show.model":26,"./00.show.unit/show.reduce":27,"./00.show.unit/show.unit":28,"./97.collect.unit/collect.model":32,"./97.collect.unit/collect.reduce":33,"./97.collect.unit/collect.unit":34,"./98.menu.unit/menu.model":38,"./98.menu.unit/menu.reduce":39,"./98.menu.unit/menu.unit":40,"./99.bus.unit/bus.model":43,"./99.bus.unit/bus.reduce":44,"./99.bus.unit/bus.unit":45}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
