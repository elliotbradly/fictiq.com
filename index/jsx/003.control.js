...
(function (global){(function (){
global.CONTROL = require("../dist/003.control/hunt");
global.CONTROL.ActCtr = require("../dist/003.control/00.control.unit/control.action");

}).call(this)}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../dist/003.control/00.control.unit/control.action":24,"../dist/003.control/hunt":52}],23:[function(require,module,exports){
(function (process){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.patchControl = exports.editControl = exports.runControl = exports.openControl = exports.updateControl = exports.initControl = void 0;
...
const updateControl = (cpy, bal, ste) => {
    ...
    exec('tsc -b 003.control', async (err, stdout, stderr) => {
        if (err) {
            console.error(`exec error: ${err}`);
        }
        process.chdir("../999.vurt");
        bit = await ste.bus(ActVrt.BUNDLE_VURT, { src: "003.control" });
        process.chdir("../003.control");
        bit = await ste.bus(ActDsk.READ_DISK, { src: './work/003.control.js' });
        var shade = bit.dskBit.dat;
        bit = await ste.bus(ActDsk.WRITE_DISK, { src: '../gillisse/public/jsx/003.control.js', dat: shade });
        ...
        setTimeout(() => {
            if (bal.slv != null)
                bal.slv({ ctrBit: { idx: "update-control" } });
        }, 3);
    });
    return cpy;
};
exports.updateControl = updateControl;
const openControl = async (cpy, bal, ste) => {
    bit = await ste.bus(ActDsk.COPY_DISK, { src: './source', idx: '../gillisse/src' });
    bit = await ste.hunt(ActCtr.RUN_CONTROL, {});
    const open = require('open');
    var loc = './vrt.opn.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ ctrBit: { idx: "open-control" } });
    }, 33);
    return cpy;
};
exports.openControl = openControl;
const runControl = async (cpy, bal, ste) => {
    const open = require('open');
    var loc = './vrt.gil.bat';
    bit = await open(loc);
    setTimeout(() => {
        if (bal.slv != null)
            bal.slv({ ctrBit: { idx: "run-control" } });
    });
    return cpy;
};
exports.runControl = runControl;
const editControl = (cpy, bal, ste) => {
    const { exec } = require('child_process');
    ...
    exec('start Code.exe ../packages/gillisse', async (err, stdout, stderr) => {
        ...
        process.chdir("../packages/003.control");
        if (bal.slv != null)
            bal.slv({ ctrBit: { idx: "edit-control", dat: {} } });
    });
    return cpy;
};
exports.editControl = editControl;
var patch = (ste, type, bale) => ste.dispatch({ type, bale });
const patchControl = (cpy, bal, ste) => {
    debugger;
    return cpy;
};
...
},{"../../00.control.unit/control.action":24,"../../98.menu.unit/menu.action":36,"../../99.bus.unit/bus.action":41,"../../act/disk.action":49,"../../act/vurt.action":51,"_process":10,"child_process":undefined,"open":undefined}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PatchControl = exports.PATCH_CONTROL = exports.EditControl = exports.EDIT_CONTROL = exports.RunControl = exports.RUN_CONTROL = exports.OpenControl = exports.OPEN_CONTROL = exports.UpdateControl = exports.UPDATE_CONTROL = exports.InitControl = exports.INIT_CONTROL = void 0;
// Control actions
...
exports.OpenControl = OpenControl;
exports.RUN_CONTROL = "[Run action] Run Control";
class RunControl {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RUN_CONTROL;
    }
}
exports.RunControl = RunControl;
exports.EDIT_CONTROL = "[Edit action] Edit Control";
class EditControl {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.EDIT_CONTROL;
    }
}
exports.EditControl = EditControl;
exports.PATCH_CONTROL = "[Patch action] Patch Control";
class PatchControl {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.PATCH_CONTROL;
    }
}
exports.PatchControl = PatchControl;
...
var control_buzz_4 = require("./buz/control.buzz");
Object.defineProperty(exports, "runControl", { enumerable: true, get: function () { return control_buzz_4.runControl; } });
var control_buzz_5 = require("./buz/control.buzz");
Object.defineProperty(exports, "editControl", { enumerable: true, get: function () { return control_buzz_5.editControl; } });
var control_buzz_6 = require("./buz/control.buzz");
Object.defineProperty(exports, "patchControl", { enumerable: true, get: function () { return control_buzz_6.patchControl; } });

},{"./buz/control.buzz":23}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ControlModel = void 0;
class ControlModel {
    constructor() {
        this.idx = '003.control';
...
function reducer(model = new control_model_1.ControlModel(), act, state) {
    switch (act.type) {
        ...
        case Act.RUN_CONTROL:
            return Buzz.runControl(clone(model), act.bale, state);
        case Act.EDIT_CONTROL:
            return Buzz.editControl(clone(model), act.bale, state);
        case Act.PATCH_CONTROL:
            return Buzz.patchControl(clone(model), act.bale, state);
        default:
            return model;
    }
}
...
},{"./control.action":24,"./control.buzzer":25,"./control.model":26,"clone-deep":3}],28:[function(require,module,exports){
"use strict";
...
const updateMenu = async (cpy, bal, ste) => {
    ...
    bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
    var lst = [ActCtr.UPDATE_CONTROL, ActCtr.OPEN_CONTROL, ActCtr.EDIT_CONTROL];
    bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
    bit = bit.trmBit;
    var idx = lst[bit.val];
    switch (idx) {
        case ActCtr.OPEN_CONTROL:
            bit = await ste.hunt(ActCtr.OPEN_CONTROL, {});
            break;
        case ActCtr.UPDATE_CONTROL:
            bit = await ste.hunt(ActCtr.UPDATE_CONTROL, {});
            //bit = await ste.hunt(ActShd.OPEN_SHADE, {})
            break;
        case ActCtr.EDIT_CONTROL:
            bit = await ste.hunt(ActCtr.EDIT_CONTROL, {});
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "PATCHING...", bit: 'local' });
            bit = await ste.bus(ActTrm.WRITE_TERMINAL, { src: "-----------", bit: "local" });
            lst = [ActCtr.PATCH_CONTROL];
            bit = await ste.bus(ActTrm.UPDATE_TERMINAL, { lst });
            bit = await ste.hunt(ActCtr.PATCH_CONTROL, {});
            break;
        default:
...
},{"../../00.control.unit/control.action":24,"../../act/terminal.action":50}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./00.control.unit/control.model":26,"./00.control.unit/control.reduce":27,"./00.control.unit/control.unit":28,"./97.collect.unit/collect.model":32,"./97.collect.unit/collect.reduce":33,"./97.collect.unit/collect.unit":34,"./98.menu.unit/menu.model":38,"./98.menu.unit/menu.reduce":39,"./98.menu.unit/menu.unit":40,"./99.bus.unit/bus.model":43,"./99.bus.unit/bus.reduce":44,"./99.bus.unit/bus.unit":45}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
