...
(function (global){(function (){
global.MACHINE = require("../dist/555.machine/hunt");
global.MACHINE.ActMec = require("../dist/555.machine/00.machine.unit/machine.action");
...
class InitMachine {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.INIT_MACHINE;
    }
}
exports.InitMachine = InitMachine;
exports.UPDATE_MACHINE = "[Machine action] Update Machine";
class UpdateMachine {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.UPDATE_MACHINE;
    }
}
exports.UpdateMachine = UpdateMachine;
exports.OPEN_MACHINE = "[Open action] Open Machine";
class OpenMachine {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.OPEN_MACHINE;
    }
}
exports.OpenMachine = OpenMachine;
exports.RUN_MACHINE = "[Run action] Run Machine";
class RunMachine {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.RUN_MACHINE;
    }
}
exports.RunMachine = RunMachine;
exports.EDIT_MACHINE = "[Edit action] Edit Machine";
class EditMachine {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.EDIT_MACHINE;
    }
}
exports.EditMachine = EditMachine;
exports.PATCH_MACHINE = "[Patch action] Patch Machine";
class PatchMachine {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.PATCH_MACHINE;
    }
}
exports.PatchMachine = PatchMachine;
...
Object.defineProperty(exports, "updateMachine", { enumerable: true, get: function () { return machine_buzz_2.updateMachine; } });
var machine_buzz_3 = require("./buz/machine.buzz");
Object.defineProperty(exports, "openMachine", { enumerable: true, get: function () { return machine_buzz_3.openMachine; } });
var machine_buzz_4 = require("./buz/machine.buzz");
Object.defineProperty(exports, "runMachine", { enumerable: true, get: function () { return machine_buzz_4.runMachine; } });
var machine_buzz_5 = require("./buz/machine.buzz");
...
const Act = require("./machine.action");
const machine_model_1 = require("./machine.model");
const Buzz = require("./machine.buzzer");
function reducer(model = new machine_model_1.MachineModel(), act, state) {
    switch (act.type) {
        case Act.UPDATE_MACHINE:
            return Buzz.updateMachine(clone(model), act.bale, state);
        case Act.INIT_MACHINE:
            return Buzz.initMachine(clone(model), act.bale, state);
        case Act.OPEN_MACHINE:
            return Buzz.openMachine(clone(model), act.bale, state);
        case Act.RUN_MACHINE:
            return Buzz.runMachine(clone(model), act.bale, state);
        case Act.EDIT_MACHINE:
...
},{"./machine.action":24,"./machine.buzzer":25,"./machine.model":26,"clone-deep":3}],28:[function(require,module,exports){
"use strict";
...
let MachineUnit = class MachineUnit {
    constructor(state) {
    }
};
MachineUnit = __decorate([
